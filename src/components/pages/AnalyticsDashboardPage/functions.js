...
var dataPoints = [];
var chart = new CanvasJS.Chart("chartContainer", (_ref2 = {
  ...
  exportEnabled: true,
  dataPointWidth: 20
}, _defineProperty(_ref2, "colorSet", "greenShades"), _defineProperty(_ref2, "axisY", {
  labelFontSize: 16,
  labelFormatter: function labelFormatter(e) {
    return "$" + e.value;
  },
  margin: 8
}), _defineProperty(_ref2, "data", [(_ref = {
  color: "#72e5b1",
  showInLegend: true,
  labelFontFamily: "sans-serif",
  type: 'column',
  ...
  xValueType: "dateTime"
}, _defineProperty(_ref, "showInLegend", true), _defineProperty(_ref, "name", "agents"), _defineProperty(_ref, "dataPoints", dataPoints), _ref)]), _ref2));
